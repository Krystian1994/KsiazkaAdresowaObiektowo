...
void PlikZAdresatami::usunWybranegoAdresataZpliku(int idAdresata)
{
    ...
    if (odczytywanyPlikTekstowy.good() == true)
    {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia))
        {
            ...
            else if (idAdresata != pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia) && numerWczytanejLinii == 1)
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (idAdresata < pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia) && numerWczytanejLinii == 2)
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (idAdresata < pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia) && numerWczytanejLinii > 2)
